...
Также добавлена папка Max с модулями для публикаций в Максе.
...
"FileNameRaspisES" - имя основного файла расписания на сегодня.
"fromES" - переключатель true/false, если true - используется функционал расписания с ES, иначе - обычное расписание местности.
"useMax" - переключатель true/false для включения рассылки в Макс.
