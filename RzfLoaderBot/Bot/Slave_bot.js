...
class SlaveBot {
            ...
            try {
                ...
                if (chatType === 'channel') {
                    ...
                    helpText += `*👤 В приватном чате:*\n` +
                               `${this.escapeMarkdown('/config_channel')} - настроить канал\n` +
    ...
    escapeMarkdown(text) {
        ...
        // Экранируем только спецсимволы Markdown, которые могут быть в названиях каналов
        ...
        try {
            ...
            if (!botIsAdmin) {
                ...
                await this.bot.sendMessage(userId,
                    ...
                    `4. Включите разрешение "Отправка сообщений"`,
                    {
                        parse_mode: 'Markdown',
                        reply_markup: {
                            inline_keyboard: [[
