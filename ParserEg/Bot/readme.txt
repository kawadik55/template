...
При запуске скрипт запрашивает официальный сайт https://na-russia.org, получает текст Ежика на сегодня и сохраняет его
...
"DirEg" - массив путей к директориям для сохранения файлов, относительно рабочей директории;
...
Дополнительно к файлам Ежика в тех же местах создается файл timestamp.json, в котором фиксируется момент записи
сегодняшнего Ежика. Этот UnixTime используется другими службами для определения нужной даты Ежика в различных часовых поясах.
