...
docker run --name name_bot -v ДОМ/РЕГИОН:/home/pi/РЕГИОН:rw --restart=unless-stopped -d -e "CURRENT_DIR=ДОМ/РЕГИОН/LoaderBot" kawadiyk/loaderbot:latest ./loader_bot
...
3.
docker run --name name_bot -v ДОМ/РЕГИОН:/home/pi/РЕГИОН:rw --restart=unless-stopped -d -e "CURRENT_DIR=ДОМ/РЕГИОН/БОТ" kawadiyk/loaderbot:latest ./loader_bot
